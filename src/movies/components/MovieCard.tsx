...
export const MovieCard = ({ movie }: MovieCardProps) => {
  ...
  return (
    <div data-testid={`movie-item-${movie.id}`}>
      <img className="card-img-top" alt={movie.title} src={movie.imageUrl} />
      ...
      <div className="card-footer">
        <div className="clearfix">
          <div className="float-left mt-1">
            <StarRating rating={getAvgRating(movie)} onRate={handleRating} />
          </div>
          <div data-testid="movie-rating">{getAvgRating(movie)}</div>
